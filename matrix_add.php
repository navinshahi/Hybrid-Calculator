...
<html lang="en">
<head>
    <title>Hybrid Calculator: Matrix Addition</title>
    ...
    <meta name="keywords" content="addition of matrix,matrix addition,matrix calculator,Calculator,CALCULATOR,add matrix,add matrix online,online matrix addition,add two matrix,add 2 matrix,matrix add online,calculate sum of matrix,matrix sum,sum of two matrix">
