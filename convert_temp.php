...
<html lang="en">
<head>
    <title>Hybrid Calculator: Temperature Conversion</title>
    ...
    <meta name="description" content="Online converter for temperature units. Degrees Fahrenheit, degrees Celsius, Kelvin. Instantly convert any value to all others.">
    <meta name="keywords" content="Temperature conversion,convert Temperature,f to c,fahrenheit to celsius,celsius to kelvin,c to k,fahrenheit to kelvin,kelvin to fahrenheit,kelvin to celsius,celsius to kelvin,celsius to fahrenheit">
...
<body style="font-family:'Open Sans',Helvetica,Arial,sans-serif;background-color:#43e97b;">
    ...
    <div class="main_frame">
        ...
        <div class="frame_2">
            <div class="subframe_1"><div class="text_1">Temperature Conversion</div></div>
            <div class="subframe_2">
                <div class="subsub1">
                <div class="subcont1">  
                <select id="select1" class="form-control" onchange="calculate()">
                    <option value="select1">From Temperature</option>
                ...
                <select id="select2" class="form-control" onchange="calculate()">
                    <option value="select2">To Temperature</option>
                    <option value="C">Celsius (&#176;C)</option>
                    <option value="F">Fahrenheit (&#176;F)</option>
                    <option value="K">Kelvin (K)</option>
                </select>
