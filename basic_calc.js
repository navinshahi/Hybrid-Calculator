...
function fkey6() {
    ...
    input.value=Math.sin(parseInt(st)*(Math.PI/180));
}
function fkey7() {
    var input=document.getElementById("screen");
    var st=input.value;
    ...
    input.value=Math.cos(parseInt(st)*(Math.PI/180));
}
function fkey8() {
    var input=document.getElementById("screen");
    var st=input.value;
    ...
    input.value=Math.tan(parseInt(st)*(Math.PI/180));
}
function fkey9() {
    var input=document.getElementById("screen");
    input.value+="7";
...
function fkey15() {
    ...
    input.value=1/Math.sin(parseInt(st)*(Math.PI/180));
}
function fkey16() {
    var input=document.getElementById("screen");
    var st=input.value;
    ...
    input.value=1/Math.cos(parseInt(st)*(Math.PI/180));
}
function fkey17() {
    var input=document.getElementById("screen");
    var st=input.value;
    ...
    input.value=1/Math.tan(parseInt(st)*(Math.PI/180));
}
function fkey18() {
    var input=document.getElementById("screen");
    input.value+="4";
